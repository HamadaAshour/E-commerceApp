...
import pages.P08_ShoppingCartPage;
import pages.P11_CheckoutPage;
import org.testng.Assert;
import java.time.Duration;
import static stepDefs.Hooks.driver;
public class SD12_Checkout {
    P08_ShoppingCartPage shoppingCart = new P08_ShoppingCartPage();
    P11_CheckoutPage checkout = new P11_CheckoutPage();
