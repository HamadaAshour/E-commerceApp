...
public class SD10_Wishlist {
    ...
    public void product_has_been_added_to_wishlist_message_displayed() throws InterruptedException {
        ...
        System.out.println("\n--- Test Scenario NO14 (Wishlist) | Confirmation Message Displayed Comparison: ---");
    ...
    public void webpage_redirects_to_wishlist() {
        ...
        System.out.println("\n--- Test Scenario NO14 (Wishlist) | Redirected Website after clicking on Wishlist Button Comparison: ---");
    ...
    public void second_product_is_Displayed() {
        ...
        System.out.println("\n--- Test Scenario NO14 (Wishlist) | 2nd Item Displayed Comparison: ---");
    ...
    public void third_product_is_Displayed() {
        ...
        Assert.assertTrue(actualResult.contains(expectedResult));
        System.out.println("\n--- Test Scenario NO14 (Wishlist) | 3rd Item Displayed Comparison: ---");
        System.out.println("** Actual Item Displayed Result = " + actualResult);
        System.out.println("** Expected Item Displayed Result = " + expectedResult);
    }
